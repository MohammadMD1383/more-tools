...
object Items {
	...
	//@formatter:off
	@JvmStatic val AMETHYST_SWORD   = register(ItemIds.AMETHYST_SWORD  , Properties().sword  (ToolMaterials.AMETHYST, 2f, -2.2f))
	@JvmStatic val AMETHYST_SPEAR   = register(ItemIds.AMETHYST_SPEAR  , Properties().spear  (ToolMaterials.AMETHYST, 0.75f, 0.95f, 0.4f, 3.5f, 9.0f, 7.75f, 4f, 12f, 4.6f))
	@JvmStatic val AMETHYST_PICKAXE = register(ItemIds.AMETHYST_PICKAXE, Properties().pickaxe(ToolMaterials.AMETHYST, 1f, -2.6f))
	@JvmStatic val AMETHYST_AXE     = register(ItemIds.AMETHYST_AXE    , Properties().axe    (ToolMaterials.AMETHYST, 6f, -2.9f))
