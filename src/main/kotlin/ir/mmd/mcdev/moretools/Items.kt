...
object Items {
	...
	@JvmStatic val OBSIDIAN_HELMET         = register(ItemIds.OBSIDIAN_HELMET,     Properties().humanoidArmor(MyArmorMaterials.OBSIDIAN, ArmorType.HELMET).nonEnchantable())
	@JvmStatic val OBSIDIAN_CHESTPLATE     = register(ItemIds.OBSIDIAN_CHESTPLATE, Properties().humanoidArmor(MyArmorMaterials.OBSIDIAN, ArmorType.CHESTPLATE).nonEnchantable())
	@JvmStatic val OBSIDIAN_LEGGINGS       = register(ItemIds.OBSIDIAN_LEGGINGS,   Properties().humanoidArmor(MyArmorMaterials.OBSIDIAN, ArmorType.LEGGINGS).nonEnchantable())
	@JvmStatic val OBSIDIAN_BOOTS          = register(ItemIds.OBSIDIAN_BOOTS,      Properties().humanoidArmor(MyArmorMaterials.OBSIDIAN, ArmorType.BOOTS).nonEnchantable())
	...
	@JvmStatic val OBSIDIAN_HORSE_ARMOR    = register(ItemIds.OBSIDIAN_HORSE_ARMOR,    Properties().horseArmor   (MyArmorMaterials.OBSIDIAN).nonEnchantable())
	@JvmStatic val OBSIDIAN_NAUTILUS_ARMOR = register(ItemIds.OBSIDIAN_NAUTILUS_ARMOR, Properties().nautilusArmor(MyArmorMaterials.OBSIDIAN).nonEnchantable())
	@JvmStatic val OBSIDIAN_WOLF_ARMOR     = register(ItemIds.OBSIDIAN_WOLF_ARMOR,     Properties().wolfArmor    (MyArmorMaterials.OBSIDIAN).nonEnchantable())
