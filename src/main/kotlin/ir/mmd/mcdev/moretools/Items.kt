...
object Items {
	...
	@JvmStatic val OBSIDIAN_SPEAR = register(ItemIds.OBSIDIAN_SPEAR, Properties().spear(ToolMaterials.OBSIDIAN, 1.25f, 0.820f, 0.7f, 4.5f, 13.0f, 9.00f, 5.1f, 13.75f, 4.6f))
	...
	@JvmStatic val OBSIDIAN_SWORD   = register(ItemIds.OBSIDIAN_SWORD,   Properties().sword  (ToolMaterials.OBSIDIAN,  3.0f, -2.8f))
	@JvmStatic val OBSIDIAN_PICKAXE = register(ItemIds.OBSIDIAN_PICKAXE, Properties().pickaxe(ToolMaterials.OBSIDIAN,  1.0f, -3.1f))
	@JvmStatic val OBSIDIAN_AXE     = register(ItemIds.OBSIDIAN_AXE,     Properties().axe    (ToolMaterials.OBSIDIAN,  7.0f, -3.4f))
	@JvmStatic val OBSIDIAN_SHOVEL  = register(ItemIds.OBSIDIAN_SHOVEL,  Properties().shovel (ToolMaterials.OBSIDIAN,  1.5f, -3.3f))
	@JvmStatic val OBSIDIAN_HOE     = register(ItemIds.OBSIDIAN_HOE,     Properties().hoe    (ToolMaterials.OBSIDIAN, -1.0f, -3.3f))
	...
	@JvmStatic val OBSIDIAN_HELMET         = register(ItemIds.OBSIDIAN_HELMET,     Properties().humanoidArmor(MyArmorMaterials.OBSIDIAN, ArmorType.HELMET))
	@JvmStatic val OBSIDIAN_CHESTPLATE     = register(ItemIds.OBSIDIAN_CHESTPLATE, Properties().humanoidArmor(MyArmorMaterials.OBSIDIAN, ArmorType.CHESTPLATE))
	@JvmStatic val OBSIDIAN_LEGGINGS       = register(ItemIds.OBSIDIAN_LEGGINGS,   Properties().humanoidArmor(MyArmorMaterials.OBSIDIAN, ArmorType.LEGGINGS))
	@JvmStatic val OBSIDIAN_BOOTS          = register(ItemIds.OBSIDIAN_BOOTS,      Properties().humanoidArmor(MyArmorMaterials.OBSIDIAN, ArmorType.BOOTS))
	...
	@JvmStatic val OBSIDIAN_HORSE_ARMOR    = register(ItemIds.OBSIDIAN_HORSE_ARMOR,    Properties().horseArmor   (MyArmorMaterials.OBSIDIAN))
	@JvmStatic val OBSIDIAN_NAUTILUS_ARMOR = register(ItemIds.OBSIDIAN_NAUTILUS_ARMOR, Properties().nautilusArmor(MyArmorMaterials.OBSIDIAN))
	@JvmStatic val OBSIDIAN_WOLF_ARMOR     = register(ItemIds.OBSIDIAN_WOLF_ARMOR,     Properties().wolfArmor    (MyArmorMaterials.OBSIDIAN))
