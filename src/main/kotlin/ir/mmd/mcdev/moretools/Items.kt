...
object Items {
	...
	@JvmStatic val QUARTZ_SWORD     = register(ItemIds.QUARTZ_SWORD,     Properties().sword  (ToolMaterials.QUARTZ,    3.0f, -2.4f).quartzMiningEfficiency(BlockTags.QUARTZ_SWORD_INSTANT,   BlockTags.QUARTZ_SWORD_FAST))
	@JvmStatic val QUARTZ_PICKAXE   = register(ItemIds.QUARTZ_PICKAXE,   Properties().pickaxe(ToolMaterials.QUARTZ,    1.0f, -2.8f).quartzMiningEfficiency(BlockTags.QUARTZ_PICKAXE_INSTANT, BlockTags.QUARTZ_PICKAXE_FAST))
	@JvmStatic val QUARTZ_AXE       = register(ItemIds.QUARTZ_AXE,       Properties().axe    (ToolMaterials.QUARTZ,    6.0f, -3.0f).quartzMiningEfficiency(BlockTags.QUARTZ_AXE_INSTANT,     BlockTags.QUARTZ_AXE_FAST))
	...
	@JvmStatic val LAPIS_WOLF_ARMOR        = register(ItemIds.LAPIS_WOLF_ARMOR,        Properties().wolfArmor    (MyArmorMaterials.LAPIS).nonEnchantable())
